<script type="text/javascript">
    ...
    function load_table(){
        $('#tbl1').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url("Journal/get_data_journal/"); ?>'
            },
            "columns": [
              {"name": "id"},
              {"name": "picture"},
    ...
    function do_edit(id){
        $.ajax({
            url: '<?= base_url() ?>Journal/get_detail/'+id,
            type: 'POST',
            dataType: 'json',
            success:function(data){ 
                ...
                $("#img_preview").attr('src' , '<?= base_url() ?>assets/picture/pic_journal/'+data.picture);
    ...
    function edit_process(){
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>Journal/save_journal/'+id,
            data: data,
            dataType: 'json',
            contentType: false,
            cache: false,
    ...
    function do_delete(id){
        ...
        Swal.fire({
          ...
          if (result.value) {
            $.ajax({
                url: '<?= base_url() ?>Journal/do_delete/'+id,
                type: 'get',
                dataType: 'json',
                success:function(resp){
                     Swal.fire(
